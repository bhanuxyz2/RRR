...
ADMIN_IDS = {"7086729173,521756472"}
CHANNEL_USERNAME = "@TEAM NEHI HAI KYA"
FEEDBACK_CHANNEL = "@@Chhotuddosteam"
CONTACT_ADMINS = ["@ChhotuDDOS", "@ChhotuDDOS"]
...
🔥 Join @Chhotuddosteam & @Chhotuddosteam to use!
💎 +1 attack per invite to @Chhotuddosteam after limit or buy unlimited from @bhanuxyz2
"""
